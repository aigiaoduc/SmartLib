...
import { BookOpen, Video, MonitorPlay, FileQuestion, MessageSquareText, Home, FileText, Gamepad2 } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setView, isOpen, toggleSidebar }) => {
  const menuItems = [
    ...
    { id: ViewState.GAMES, label: 'Trò Chơi', icon: <Gamepad2 size={28} strokeWidth={2.5} />, color: 'text-pink-500', bg: 'bg-pink-100', hover: 'hover:bg-pink-200' }, // New Item
